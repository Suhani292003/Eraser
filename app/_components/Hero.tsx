...
function Hero() {
  return (
    <section className="bg-black">
        ...
        text-center border-white'>See More | <span className='text-sky-300'>AI Diagram</span></h2>
        </div>
    ...
    <div className="mx-auto h-screen max-w-screen-xl px-4 py-12 lg:flex">
      <div className="mx-auto max-w-xl text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <a
            className="block w-full rounded bg-white text-black px-12 py-3 text-sm font-medium text-white shadow hover:bg-red-700 focus:outline-none focus:ring active:bg-red-500 sm:w-auto"
            href="#"
          >
            Learn More
          </a>
